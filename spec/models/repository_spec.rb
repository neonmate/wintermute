describe Repository do
  ...
  describe '#validate' do
    ...
    it { is_expected.not_to allow_value('other').for(:delivery_model) }
    ...
    context 'with state draft' do
      ...
      it { is_expected.not_to validate_presence_of(:preview_image) }
      it { is_expected.not_to validate_presence_of(:delivery_model) }
      it { is_expected.not_to validate_presence_of(:categories) }
    end
