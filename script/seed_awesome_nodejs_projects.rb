...
ActiveRecord::Base.transaction do
  Project.create!(
    ...
    application_url: 'http://keystonejs.com/',
  ...
  Project.create!(
    ...
    application_url: 'https://pencilblue.org/',
  ...
  Project.create!(
    ...
    application_url: 'http://apostrophecms.org/',
  ...
  Project.create!(
    ...
    application_url: 'http://cody-cms.org/en/',
  ...
  Project.create!(
    ...
    application_url: 'http://hashbrown.rocks/',
  ...
  Project.create!(
    ...
    application_url: 'http://strapi.io',
  ...
  Project.create!(
    ...
    application_url: 'http://endurojs.com',
  ...
  Project.create!(
    ...
    application_url: 'http://raneto.com/',
  ...
  Project.create!(
    ...
    application_url: 'http://shields.io/',
  ...
  Project.create!(
    ...
    application_url: 'https://david-dm.org/',
  ...
  Project.create!(
    ...
    application_url: 'https://code.visualstudio.com/',
  ...
  Project.create!(
    ...
    application_url: 'https://tellform.com',
  ...
  Project.create!(
    ...
    application_url: 'http://witheve.com/',
  ...
  Project.create!(
    ...
    application_url: 'https://ghost.org/',
  ...
  Project.create!(
    ...
    application_url: 'http://reptar.github.io/',
  ...
  Project.create!(
    ...
    application_url: 'https://cloudcmd.io',
  ...
  Project.create!(
    ...
    application_url: 'http://mediacenterjs.com/',
  ...
  Project.create!(
    ...
    application_url: 'https://habitica.com/static/front',
  ...
  Project.create!(
    ...
    application_url: 'http://timeoff.management/',
  ...
  Project.create!(
    ...
    application_url: 'http://www.gadael.org',
  ...
  Project.create!(
    ...
    application_url: 'https://nasa.github.io/openmct/',
  ...
  Project.create!(
    ...
    application_url: 'https://www.facebook.com/PokedexGo/',
  ...
  Project.create!(
    ...
    application_url: 'https://shiigehiro.github.io/system',
