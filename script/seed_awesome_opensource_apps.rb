...
Project.create!(
  title: 'Sharetribe',
  subtitle: 'A Marketplace Platform',
...
Project.create!(
  title: 'Rails port of OpenstreetMap',
...
Project.create!(
  title: 'Hours',
  subtitle: "Time registration that doesn't suck",
...
Project.create!(
  ...
  application_url: 'http://www.discourse.org',
  user: user,
)
...
Project.create!(
  ...
  application_url: 'http://www.redmine.org',
  user: user,
)

Project.create!(
  title: 'Diaspora',
  subtitle: 'Distributed Social Network',
